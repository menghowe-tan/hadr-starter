...
| V3 | Unattended at 08:30 | Sitrep + Leaflet map live on the external host from a scheduled Actions run; loud failure when blind | §3 render/deploy, §7 degraded/abort, design §2–§3, §6 |
